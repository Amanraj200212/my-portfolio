...
const counterItems = [
  ...
  { value: 2, suffix: "", label: "Backend projects" },
...
const expCards = [
  {
    review:
      "Aman brought creativity and technical expertise to the team, significantly improving our frontend performance. His work has been invaluable in delivering faster experiences.",
  ...
  {
    review:
      "Aman’s contributions to appwrite's web applications have been outstanding. He approaches challenges with a problem-solving mindset.",
    imgPath: "/images/exp2.png",
    logoPath: "/images/logo2.png",
    title: "Full Stack Developer",
    date: "December 2025 - present",
    responsibilities: [
      "Led the development of React's web applications, focusing on scalability.",
  ...
  {
    review:
      "I have deployed and mainted web appliaction using vercel, ensuring good performance and seamless user experience",
    imgPath: "/images/exp3.png",
    logoPath: "/images/logo3.png",
    title: "React Developer",
    date: "March 2019 - May 2020",
    responsibilities: [
      "Built cross-platform web apps using React, integrating with Appwrite's backend services.",
...
const socialImgs = [
  {
    name: "insta",
    url: "https://www.instagram.com/4mangupta_?igsh=YXAzYXhuMHA1ajNi",
  ...
  {
    name: "linkedin",
    url: "https://www.linkedin.com/in/4mangupta99",
